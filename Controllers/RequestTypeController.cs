...
namespace TestApi.Controllers
{
    ...
    {
        private readonly IRequestTypeService<RequestType> _requestService;
        ...
        [HttpGet("getByType")]
        public async Task<IActionResult> GetByReqyestType(string type)
        {
            try
            {
                var data = await _requestService.GetByReqyestType(type);
                return new OkObjectResult(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost("create")]
        public async Task<IActionResult> Create([FromBody] RequestType oUser)
        {
            try
            {
        ...
        [HttpPut("update")]
        public async Task<IActionResult> Update([FromBody] RequestType model)
        {
            try
            {
